 ...
 * 5.- description es un string que tiene entre 2 a 300 caracteres.
...
const createGame = async (
  newObject: Omit<GameData, "id" | "rating" | "reviews">
) => {
  try {
 ...
 * y tiene un largo de entre 10 a 300 caracteres.
 * 5.- para el caso de description, debe ser un string que tiene entre 2 a 300 caracteres.
